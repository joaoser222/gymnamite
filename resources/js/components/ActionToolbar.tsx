...
import { IconPlus, IconTrash, IconEye, IconEyeOff, IconArchive, IconSettings } from '@tabler/icons-react';
import { TableColumn } from './ServerTable';
...
export function ActionToolbar({ columns, onSearchChange, onVisibilityChange, onCreate }: ActionToolbarProps) {
    ...
    <Grid gutter="sm">
      <Grid.Col span={{ base: 12 }}>
        <Group justify="right" py="sm">
          <Button rightSection={<IconEye size={20} />} variant="default">
            Alterar visibilidade
          </Button>
          <Button rightSection={<IconTrash size={20} />} variant="default" bg="red">
            Deletar
          </Button>
          <Button rightSection={<IconPlus size={20} />} variant="default" bg="blue" onClick={onCreate}>
            Adicionar
          </Button>
        </Group>
      </Grid.Col>
        ...
        <Button.Group py="sm">
          {visibilityOptions.map((option) => (
            <Button
              ...
              variant="default"
              bg={option.value === visibilityValue ? 'dark.5' : 'dark.7'}
