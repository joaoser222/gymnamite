...
const props = defineProps<{
    trainers: PaginatedResponse<any>;
    routes: IndexRoutes;
}>();
...
const headers: TableHeader[] = [
    ...
    { title: 'CPF', key: 'document', searchable: { component: 'MaskedTextField', props: { mask: masks.cpf } } },
...
<template>
    <TablePage
        ...
        :current-page="trainers.current_page"
        :last-page="trainers.last_page"
        :per-page="trainers.per_page"
        :headers="headers"
        :routes="routes"
        module="trainers"
        title="Treinadores"
